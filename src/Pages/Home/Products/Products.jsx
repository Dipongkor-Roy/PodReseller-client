...
const Products = () => {
    return (
        <section className="text-gray-600 body-font mt-[65px]">
            <h5 className="sm:text-3xl font-gabarito title-font  text-gray-600 text-center font-extrabold text-4xl md:text-5xl tracking-tight ">Products</h5>
